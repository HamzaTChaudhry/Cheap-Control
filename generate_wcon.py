# Generate WCON data file that contains relevant information regarding the worm's postural dynamics, which we will then use to quantify and compare behavior.
# This works well but I wrote this in a rush while leaving Germany. I need to optimize, clean, and comment this code out before I write the paper.
import math
import sys
import os
import numpy as np
...
if __name__ == '__main__':
    ...
    test_sim = 'C2_FW_2018-08-27_12-16-39'
